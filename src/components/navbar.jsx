...
const Navbar = () => {
  ...
  return (
    <nav className="w-full bg-white text-black md:h-24 h-16 shadow">
      <div className="flex items-center justify-between w-full">
        {/* Logo */}
        <img
          className="w-28 md:w-44 md:h-24 h-16  ml-5 md:ml-24"
          src="./h-logo.png"
          alt="Logo"
        />
        ...
        <div className="hidden md:flex items-center space-x-10 mr-20">
          ...
          <h1 className="hover:text-green-600">Find Service Tags</h1>
